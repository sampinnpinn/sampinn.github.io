		...
		success: function (data) {
			...
			if (data.data.records[0].fields.fld6GnV53waKK) {
				...
				if (check == 1) {
					...
					var mydata = '<h5>' + ctitle + '</h5> <small class="text-muted"><i class="bi bi-eye"></i>&nbsp;' + see + '&nbsp;&nbsp;&nbsp;</small><small class="text-muted">&nbsp;<i class="bi bi-calendar2"></i>&nbsp;更新于&nbsp;' + time + '</small> <span class="badge rounded-pill" style="background-color:' + color + ' ;">' + type + '</span> <div class="mt-2 col-12"> <img src="' + imgurl + '" alt="" width="400" class="myimg"> </div>';
					$(".que").html(mydata);
				...
				if (check == 1) {
					...
					var mydata = '<h5>' + ctitle + '</h5> <small class="text-muted"><i class="bi bi-eye"></i>&nbsp;' + see + '&nbsp;&nbsp;&nbsp;</small><small class="text-muted"><i class="bi bi-calendar2"></i>&nbsp;更新于&nbsp;' + time + '</small> <span class="badge rounded-pill" style="background-color:' + color + ' ;">' + type + '</span> <div class="mt-2 col-12"></div>';
					$(".que").html(mydata);

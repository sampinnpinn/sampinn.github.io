			...
			success: function (data) {
				...
				for (var i in data.data.records) {
					...
					if (q_check == 1) {
						...
						//console.log(data)
						var mydata = '<div class="list-group-item list-group-item-action"> <a href="detail.html?Id=' + Id + '" target="_blank"> <h5>' + ctitle + '</h5> </a><small class="text-muted"><i class="bi bi-eye"></i>&nbsp;' + see + '&nbsp;&nbsp;&nbsp;</small><small class="text-muted"><i class="bi bi-calendar2"></i>&nbsp;更新于&nbsp;' + time + '&nbsp;</small> <span class="badge rounded-pill" style="background-color:' + color + ' ;">' + type + '</span></div>';
						$(".queli").append(mydata);
						//$('.nice2').hide()
					}
				};
